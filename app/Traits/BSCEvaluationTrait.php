...
//                change stage
    ...
    public function acceptRejectKPIs(Request $request)
    {
        ...
        if ($evaluation && $request->line_manager_id == Auth::user()->id) {
        ...
        if ($grade && $user->job) {
            if ($user->job) {
                ...
                if ($evaluation) {
                    ...
                    return view('bsc.evaluation', compact('user', 'operation', 'evaluation', 'metrics', 'bsms', 'templates','userQuery'));
...
//        $this->notifyUserKpiChange($evaluation->user_id, $evaluation_detail->bsc_evaluation_id);
    ...
    public function mp_report(Request $request)
    {
        ...
        return view('bsc.partials.group_report',compact('measurement_period','evaluations'));

...
{
    //
    protected $fillable = ['evaluation_id','title','discussion','employee_submitted','line_manager_approved','employee_submission_date','line_manager_approval_date','rejection_reason'];

          ...
          <div class="row row-lg col-xs-12">            
            ...
            <div class="col-xs-6">
              ...
              <div class="form-group">
                ...
                <input type="text" id="mpbsp" step=".01"   name="scorecard_percentage" class="form-control " required>
              </div>
            </div>
            <div class="col-xs-6">
              ...
              <div class="form-group">
                ...
                <input type="text" id="mpbhp" step=".01"   name="behavioral_percentage" class="form-control " required>
              </div>
            </div>
            <div class="col-xs-6">
              <div class="form-group">

          ...
          <div class="col-md-9">
            ...
            <table class="table table-stripped" id="">
              ...
              <tbody>
                ...
                <span  data-toggle="tooltip" title="View"><a href="{{ url('bsc/dept_user_list?mp='.$mp->id.'&department='.$department->id) }}"  class="btn-sm btn btn-info   "><i class="fa fa-eye" aria-hidden="true"></i></a></span>
            </td>
